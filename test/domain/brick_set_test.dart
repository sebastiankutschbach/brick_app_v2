...
main() {
  group('from Json', () {
    test('valid json', () {
      ...
      expect(
          testBrickSet.setImgUrl,
          Uri.parse(
              "https://cdn.rebrickable.com/media/sets/70672-1/12578.jpg"));
      expect(testBrickSet.setUrl,
          Uri.parse("https://rebrickable.com/sets/70672-1/coles-dirt-bike/"));
...
final BrickSet testBrickSet = BrickSet.fromJson(testBrickSetJson);
const testBrickSetJson = {
  "set_num": "70672-1",
